...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">IC Library / Students</h1>
                    ...
                    <tbody>
                        @foreach ($students as $student)
                            <tr>
                                ...
                                @else
                                    <td>
                                        <a href="{{route('icLibraryClearStudentStatus', ['id' => $student->id])}}" class="btn btn-success btn sm">Clear</a>
    ...
    $(document).ready( function () {
        ...
        $('#submit').on('click', function () {
            ...
            $.ajax({
                ...
                url : `{!! route('icLibrarySubmitRemarks') !!}`,
                type : 'GET',
                data : data,
                dataType:'json',
