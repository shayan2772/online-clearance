...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Accounts / Students</h1>
                    ...
                    <tbody>
                        @foreach ($students as $student)
                            <tr>
                                ...
                                @endif
                                @if ($student->pivot->department_clearance_status)
                                    <td><a href="{{route('accountUnclearStudentStatus', ['id' => $student->id])}}" class="btn btn-danger btn-sm">Unclear</a></td>
                                @else
                                    <td><a href="{{route('accountClearStudentStatus', ['id' => $student->id])}}" class="btn btn-success btn sm">Clear</a></td>
    ...
    $(document).ready( function () {
        ...
        $('#submit').on('click', function () {
            ...
            $.ajax({
                ...
                url : `{!! route('accountSubmitRemarks') !!}`,
                type : 'GET',
                data : data,
                dataType:'json',
